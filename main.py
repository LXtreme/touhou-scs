...
# Test enemy to verify 1080 precision and lazy pointer allocation
...
test_enemy = (Component("TestEnemy", unknown_g(), 5)
    ...
    .instant.Radial(1.0, test_bullet, lib.bullet1, numBullets=20, centerAt=0)
    # .instant.Radial(2.0, test_bullet, lib.bullet1, numBullets=8, centerAt=0)
    # .instant.Radial(3.0, test_bullet, lib.bullet1, numBullets=20, centerAt=0)
    # .instant.Radial(4.0, test_bullet, lib.bullet1, numBullets=20, centerAt=0)
    # .instant.Radial(5.0, test_bullet, lib.bullet1, numBullets=20, centerAt=0)
    # .instant.Radial(6.0, test_bullet, lib.bullet1, numBullets=20, centerAt=0)
    # .instant.Radial(2.0, test_bullet, lib.bullet1, numBullets=11, centerAt=0)
    # .instant.Radial(3.0, test_bullet, lib.bullet1, numBullets=22, centerAt=0)
    # .instant.Radial(4.0, test_bullet, lib.bullet1, numBullets=23, centerAt=0)
