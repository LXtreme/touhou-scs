...
test_bullet = (Component("TestBullet", unknown_g(), 5)
    ...
    .set_context(target=e.EMPTY_BULLET)
        ...
        .MoveTowards(e.TICK, e.EMPTY_TARGET_GROUP, t=6, dist=450, type=e.Easing.EASE_IN, rate=1.6)
...
(test_enemy
    ...
    .clear_context()
    .timed.RadialWave(1.0, test_bullet, lib.bullet1, waves=10, interval=1.1, numBullets=30)
    ...
    .timed.RadialWave(1.0, test_bullet, lib.bullet1, waves=10, interval=1.1, numBullets=30)
    .pointer.CleanPointerCircle()
    .pointer.SetPointerCircle(0.4, location=middle_test, follow=True)
    .set_context(target=test_enemy.pointer.pc.all)
        .Rotate(0.5, angle=360, t=10)
        .MoveBy(0.5, dx=75, dy=0)
        .MoveBy(0.5, dx=-150, dy=0, t=1, type=e.Easing.EASE_IN_OUT, rate=2)
        .MoveBy(1.5, dx=150, dy=0, t=1, type=e.Easing.EASE_IN_OUT, rate=2)
        .MoveBy(2.5, dx=-150, dy=0, t=1, type=e.Easing.EASE_IN_OUT, rate=2)
        .MoveBy(3.5, dx=150, dy=0, t=1, type=e.Easing.EASE_IN_OUT, rate=2)
        .MoveBy(4.5, dx=-150, dy=0, t=1, type=e.Easing.EASE_IN_OUT, rate=2)
        .MoveBy(5.5, dx=150, dy=0, t=1, type=e.Easing.EASE_IN_OUT, rate=2)
        .MoveBy(6.5, dx=-150, dy=0, t=1, type=e.Easing.EASE_IN_OUT, rate=2)
        .MoveBy(7.5, dx=150, dy=0, t=1, type=e.Easing.EASE_IN_OUT, rate=2)
        .MoveBy(8.5, dx=-150, dy=0, t=1, type=e.Easing.EASE_IN_OUT, rate=2)
        .MoveBy(9.5, dx=150, dy=0, t=1, type=e.Easing.EASE_IN_OUT, rate=2)
        .MoveBy(10.5, dx=-150, dy=0, t=1, type=e.Easing.EASE_IN_OUT, rate=2)
    .clear_context()
    .timed.RadialWave(0.8 + e.TICK*3, test_bullet2, lib.bullet2, waves=20, interval=0.5, numBullets=30)
    .pointer.CleanPointerCircle()
)
